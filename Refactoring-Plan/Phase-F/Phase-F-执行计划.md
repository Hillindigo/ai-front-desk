...
|---|---|---|---|---|---|
| F0 | 2026-08-18 | 基线与决策（6df1c61） | 281/10 复现 | ✅ | 无 |
| F1 | 2026-08-18 | 契约与迁移（04dc4fe） | tests/test_knowledge_contracts.py | ✅ | 无 |
| F2 | 2026-08-18 | 管理服务与容器（59f5643） | 修复未定义 app、单实例 | ✅ | 旧适配删除条件见 F9 |
| F3 | 2026-08-18 | 发布与索引回退（0645513） | 失败保旧快照、重启恢复 | ✅ | 多进程刷新未完成 |
| F4 | 2026-08-18 | 版本化 API（d770583） | tests/test_knowledge_api.py | ✅ | 生产管理员鉴权转 Phase G |
| F5 | 2026-08-18 | 证据约束咨询（e971d5a） | 无依据降级、引用标识 | ✅ | 无 |
| F6 | 2026-08-18 | 页面与引用（500d8b7） | /sources、来源卡片 | ✅ | 无 |
| F7 | 2026-08-18 | 评测集（f9d99ab） | 评测运行器 | ✅ | 真实模型人工评测待办 |
| F8 | 2026-08-18 | 故障与 HTTP 验收（6f117fe） | 全量 340/10/0 | ✅ | 无 |
| F9 | 2026-08-18 | 文档与 Phase G 交接（本期） | README/PROJECT_MEMORY 同步 | ✅ | 审核/鉴权/审计转 Phase G |
