...
class PromptBuilder:
    ...
    def _create_system_prompt(self) -> str:
        """创建系统提示词"""
        return (
            "你是 AI Front Desk 的门店前台接待员，负责为客户解答服务项目、预约、价格、营业时间、地址、交通等相关问题。"
            ...
            "请用专业、礼貌、简洁的语言回复用户。"
            "如果用户的问题与当前门店服务完全无关（如股票、新闻等），请礼貌地告知用户你的服务范围。"
    ...
    def _create_classification_prompt_template(self) -> str:
        """创建分类提示词模板"""
        return (
            "你是一个分类器，判断用户输入是否是关于线下服务门店的咨询类问题。\n"
            "咨询类问题包括：服务项目、价格、营业时间、服务人员情况、店铺地址、交通路线、联系方式、店铺环境等。\n"
