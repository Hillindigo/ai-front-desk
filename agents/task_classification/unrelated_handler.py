...
class UnrelatedHandler:
    ...
    def __init__(self, state_manager: StateManager):
        ...
        self._default_replies = [
            "抱歉，我无法处理这个问题。我可以帮您了解门店服务、排班和预约安排。",
            "很抱歉，这个问题不在当前门店运营范围内。如果您想了解服务内容或进行预约，我很乐意为您提供帮助！",
            "这个问题超出了我的服务范围。我主要协助处理门店咨询、预约和客户服务，有什么可以为您服务的吗？"
        ]
        self._reply_index = 0
    ...
    def set_business_context(self, service_name: str = "线下服务项目") -> None:
        """设置业务上下文，自定义回复中的服务名称"""
        self._default_replies = [
