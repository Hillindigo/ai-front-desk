...
class TaskClassifier:
    ...
    def _initialize_prompt(self):
        ...
        self.prompt = PromptTemplate(
            ...
            template=(
                "你是 AI Front Desk 的门店运营助手，你会处理来自客户和服务人员的消息，你的任务是对本次任务进行分类。\n"
                "用户可能会咨询服务价格、有哪些服务人员、各自的特点等，这类任务归类为查询任务。\n"
                "用户可能会请求预约，比如'请帮我预约今天下午3点的肩颈放松服务1小时'，这类任务归类为预约任务。\n"
                "appointment Agent 也可能发来任务，告知用户选择了某位服务人员完成某个项目，这类任务归类为支付任务。\n"
                "服务人员可能会发来任务，比如告知某个客户需要延长服务时间，这类任务归类为预约任务。\n"
                "服务人员也可能告知已完成当前服务，这类任务归类为统计任务。\n"
                ...
                "5. other（其它任务）\n"
                "只返回类别英文名。\n\n"
                "举例说明：假如task为'我要预约8号服务人员1小时的肩颈放松'，则输出appointment。\n"
                "假如输入为我想问一下门店在哪里，则输入query。\n"
                "以下是本次归类任务:\n"
                "任务内容：{task}"
            )
        )
